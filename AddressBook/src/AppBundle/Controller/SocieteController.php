...
class SocieteController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('societes_show', array('id' => $societe->getId()));
        }
     ...
     *
     * @Route("/{id}/edit", name="societes_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Societe $societe)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('societes_edit', array('id' => $societe->getId()));
        }
    ...
    public function deleteAction(Request $request, Societe $societe)
    {
        ...
        return $this->redirectToRoute('societes_index');
    }
    ...
    private function createDeleteForm(Societe $societe)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('societes_delete', array('id' => $societe->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
